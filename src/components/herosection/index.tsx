...
export default function HeroSection() {
    return (
        <section className="flex flex-row items-center justify-between bg-verde-claro">
            <div className="flex flex-col items-start justify-center px-36 gap-8 w-7/12">
            ...
            <Image src="/assets/fotopaula.png" alt="foto" width={200} height={200} className='w-5/12' />
        </section>
    )
}